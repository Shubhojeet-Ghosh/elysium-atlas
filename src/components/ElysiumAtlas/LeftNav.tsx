      ...
      <div className="relative group">
        <div
          className={`bg-white dark:bg-black flex flex-col items-center justify-between h-dvh transition-all duration-300 
            ...
            ${isOpen ? "w-[280px]" : "w-20 overflow-hidden"}
            lg:translate-x-0`}
        >
          ...
          <div className="w-full flex lg:hidden justify-between items-center px-0.5">
            ...
            <PanelRightOpen
              className="w-5 h-5 text-serene-purple mt-1.5 hover:bg-serene-purple hover:text-white dark:hover:bg-serene-purple dark:hover:text-white transition-all duration-200 cursor-pointer"
              onClick={toggleNav}
            />
          </div>
