...
export default function ConversationLeadBanner({
  ...
  return (
    <button
      ...
      className={`${conversationBannerShellClass} w-full justify-center gap-2.5 cursor-pointer transition-colors ${
        isComplete
    ...
    >
      <span className="flex items-center justify-center min-w-0 overflow-hidden">
